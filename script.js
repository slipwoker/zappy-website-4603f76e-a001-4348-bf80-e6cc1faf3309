document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent.';
      ...
      setTimeout(function () {
        ...
        const allErrors = contactForm.querySelectorAll('.form-error-message');
        allErrors.forEach(function (el) { el.textContent = ''; });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "G24 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4603f76e-a001-4348-bf80-e6cc1faf3309',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4603f76e-a001-4348-bf80-e6cc1faf3309';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4603f76e-a001-4348-bf80-e6cc1faf3309';
